...
# -*- coding: iso-8859-1 -*-
#-------------------------------------------------------------------------------
# Name:        Actualización de Puntos Interes
# Purpose:
#
...
arcpy.env.workspace="E:\SICAT\V_CON_METADATA.gdb"
tabla = r"Database Connections\METG_PRUEBAS_ODA.sde\METG.V_CON_METADATA"
Puntos=r"Database Connections\METG_PRUEBAS_ODA.sde\METG.Metadato_Geografico\METG.METADATO"
carpetaLogs=r"C:\Users\fgonzalezf\Documents\LogsActualizacionMetadatos"
workspace=r"Database Connections\METG_PRUEBAS_ODA.sde"
...
code_blok2= """def Calcular (campo):
    ...
    if campo[9:13]=="0005" :
        ...
        valor = "1:500.000"
    elif  campo[9:13]=="0400" or campo[9:13]=="1000" or campo[9:13]=="0000":
        valor = ""
    return valor"""
...
arcpy.CalculateField_management("in_memory/tableInMemory","NORTE",expre_Norte,"VB")
arcpy.CalculateField_management("in_memory/tableInMemory","ESTE",expre_Este,"VB")
arcpy.CalculateField_management("in_memory/tableInMemory","URL",expre_Url,"VB")
        ...
        with arcpy.da.UpdateCursor(Puntos, fields ,rowexpresion) as cursor2:
            ...
            for row2 in cursor2:
                ...
                try:
                    ...
                    print e.message
                    Fileprj.write("Error Actualizado: " + rowexpresion + "\n")
            ...
            if X==0:
                try:
                    ...
                    arcpy.Delete_management("layerApp")
                    Fileprj.write("Error ingresando Ingresado: " + rowexpresion + "\n")
                    pass
        ...
        with arcpy.da.UpdateCursor("LayerPuntos", fields ,rowexpresion) as cursor2:
            ...
            if X==0:
                try:
                    ...
                    arcpy.Delete_management("layerApp2")
                    Fileprj.write("Error Borrando Registro: " + rowexpresion + "\n")
                    pass
edit.stopOperation()
